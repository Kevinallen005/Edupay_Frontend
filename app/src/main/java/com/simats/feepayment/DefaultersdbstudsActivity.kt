...
import com.simats.feepayment.adapter.StudentListAdapter
...
class DefaultersdbstudsActivity : AppCompatActivity() {
    ...
    private fun fetchStudents(classNumber: Int) {
        retrofit.instance.getDueStudentsByClass(classNumber)
            .enqueue(object : Callback<DBstudentsResponse> {
                override fun onResponse(
                    ...
                    if (response.isSuccessful && response.body()?.status == "success") {
                        ...
                        Toast.makeText(
                            this@DefaultersdbstudsActivity,
